      ...
      <div className="container">
        ...
        >
          <SwiperSlide>
            <div className="rounded-xl bg-body-light-1 dark:bg-body-dark-12/10 px-5 py-8 shadow-card-2 sm:px-8">
              <p className="mb-6 text-base text-body-light-11 dark:text-body-dark-11">
                "Tôi đánh giá cao sự đầu tư vào các phòng lab hiện đại, giúp
                sinh viên có cơ hội thực hành chuyên sâu."
              </p>
          ...
          <SwiperSlide>
            <div className="rounded-xl bg-body-light-1 dark:bg-body-dark-12/10 px-5 py-8 shadow-card-2 sm:px-8">
              <p className="mb-6 text-base text-body-light-11 dark:text-body-dark-11">
                "Sự hướng dẫn nhiệt tình của thầy cô là một trong những yếu tố
                quan trọng giúp tôi phát triển."
              </p>
              <figure className="flex items-center gap-4">
                <div className="h-[50px] w-[50px] overflow-hidden">
                  <img
          ...
          <SwiperSlide>
            <div className="rounded-xl bg-body-light-1 dark:bg-body-dark-12/10 px-5 py-8 shadow-card-2 sm:px-8">
              <p className="mb-6 text-base text-body-light-11 dark:text-body-dark-11">
                "Tôi còn có nhiều kỷ niệm đẹp về cộng đồng sinh viên thân thiện
                và các hoạt động ngoại khóa sôi nổi tại trường. "
              </p>
              <figure className="flex items-center gap-4">
                <div className="h-[50px] w-[50px] overflow-hidden">
                  <img
                ...
                <figcaption className="flex-grow">
                  ...
                  <p className="text-xs">
                    Sinh viên khóa 5 - Ngành Truyền thông đa phương tiện
                  </p>
                </figcaption>
              </figure>
            </div>
          ...
          <SwiperSlide>
            <div className="rounded-xl bg-body-light-1 dark:bg-body-dark-12/10 px-5 py-8 shadow-card-2 sm:px-8">
              <p className="mb-6 text-base text-body-light-11 dark:text-body-dark-11">
                "Chương trình đào tạo cập nhật, theo kịp xu hướng thị trường lao
                động, giúp sinh viên có lợi thế cạnh tranh sau khi ra trường."
              </p>
              <figure className="flex items-center gap-4">
                <div className="h-[50px] w-[50px] overflow-hidden">
                  <img
                ...
                <figcaption className="flex-grow">
                  ...
                  <p className="text-xs">
                    Sinh viên khóa 7 - Ngành Kỹ thuật phần mềm
                  </p>
                </figcaption>
              </figure>
            </div>
          ...
          <SwiperSlide>
            <div className="rounded-xl bg-body-light-1 dark:bg-body-dark-12/10 px-5 py-8 shadow-card-2 sm:px-8">
              <p className="mb-6 text-base text-body-light-11 dark:text-body-dark-11">
                "Chương trình đào tạo bám sát thực tế và những kỹ năng mềm mà
                trường trang bị cho sinh viên."
              </p>
              <figure className="flex items-center gap-4">
                <div className="h-[50px] w-[50px] overflow-hidden">
                  <img
                ...
                <figcaption className="flex-grow">
                  ...
                  <p className="text-xs">
                    Sinh viên khóa 6 - Ngành Quản trị du lịch
                  </p>
                </figcaption>
              </figure>
            </div>
