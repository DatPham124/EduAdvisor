      ...
      <div class="row">
        <div class="col-12 order-first lg:col-4">
          <div class="w-full">
            ...
            <p class="mb-8 text-body-dark-11">
             Tại Đại học Ninh Kiều, chúng tôi cam kết mang đến cho sinh viên một nền giáo dục chất lượng, kết hợp giữa lý thuyết và thực hành
            </p>
            ...
            <ul>
              <li>
                <a href="javascript:void(0)"
                  class="mb-3 inline-block text-body-dark-11 hover:text-primary">Trang chủ</a>
              </li>
              <li>
                <a href="javascript:void(0)"
                  class="mb-3 inline-block text-body-dark-11 hover:text-primary">Chuyên ngành đào tạo</a>
              </li>
              <li>
                <a href="javascript:void(0)" class="mb-3 inline-block text-body-dark-11 hover:text-primary">Tư vấn trực tuyến</a>
              </li>
        ...
        <div class="col-6 lg:col-2">
          <div class="w-full">
            ...
            <ul>
              <li>
                <a href="javascript:void(0)" class="mb-3 inline-block text-body-dark-11 hover:text-primary">Đăng nhập</a>
              </li>
              <li>
                <a href="javascript:void(0)"
                  class="mb-3 inline-block text-body-dark-11 hover:text-primary">Đăng ký</a>
              </li>
            </ul>
          </div>
        </div>
